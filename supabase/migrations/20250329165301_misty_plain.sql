/*
  # Add support for matrix upload and rotation
  
  1. Changes
    - Add policy for deleting shifts
    - Update generate_shifts_for_week function
*/
...
-- Update generate_shifts_for_week function to handle any date
